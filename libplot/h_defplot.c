...
Plotter _hpgl_default_plotter = 
{
  ...
  { NULL, NULL, NULL, NULL, 
    ...
    NULL, NULL, NULL, NULL },
  /* capabilities */
  2, 2, 1, 0, 1, 0,		/* capability flags (see extern.h) */
