/* Initialization for a PS drawing state, which is one of the data members
   of any PSPlotter object.  Its components include drawing attributes, and
...
const State _ps_default_drawstate = {
