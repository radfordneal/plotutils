/* Initialization for an AI drawing state, which is one of the data members
   of any AIPlotter object.  Its components include drawing attributes, and
...
const State _ai_default_drawstate = {
