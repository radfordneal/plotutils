...
Plotter _X_default_plotter = 
{
  ...
  { NULL, NULL, NULL, NULL, 
    ...
    NULL, NULL, NULL, NULL },
  /* capabilities */
  1, 1, 1, 1, 0, 0,		/* capability flags (see extern.h) */
