...
Plotter _fig_default_plotter = 
{
  ...
  { NULL, NULL, NULL, NULL, 
    ...
    NULL, NULL, NULL, NULL },
  /* capabilities */
  1, 1, 1, 1, 0, 1,		/* capability flags (see extern.h) */
  MAXINT,			/* hard polyline length limit */
  /* output buffer */
  {NULL, 0, NULL, 0},		/* output buffer (for non-realtime plotting) */
